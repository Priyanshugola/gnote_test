...
export default function Signup() {
  ...
  return (
    <div>
        ...
        <div className="mb-3">
            <label htmlFor="name" className="form-label fw-semibold" style={{color:"#dc3545"}}>Name</label>
            <input type="text" className="form-control" name="name"onChange={onchange} value={login_crad.name} placeholder="Enter your email" style={{borderColor:"#dc3545",borderRadius:"10px"}} required /></div>
        <div className="mb-3">
